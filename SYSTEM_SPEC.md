...
| Inputs | 8 × mono line level | To mixer |
| PCB architecture | 4 separate PCBs (A, B, C, D) | Independent development and repair |
| Supply input | 32V DC external brick | SMPS, off-the-shelf |
| Internal rails | ±15V (audio), 32V (power amp) | TBD pending amp spec |
...
- [ ] Send assign switch type — toggle, slide, or rotary?
...
- [ ] Speaker load impedance (4Ω or 8Ω)
...
- [ ] Module D protection spec — fusing, TVS, reverse polarity
